...
def ingest_phone_data():
    ...
    csv_file_path = r'.\data\clean\kilimall_cookers.csv'
    ...
    try:
        with open(csv_file_path, 'r', encoding='utf-8') as file:
            ...
            for row in data_reader:
                if len(row) != 10:  # Ensure row has exactly 8 values
                ...
                cur.execute("""
                    INSERT INTO cookers (id,name,price,brand,capacity,type,reviews,category,source,url)
